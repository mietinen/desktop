...
local function worker(args)
    ...
    styles.focus = {
        ...
        bg_color = xrdb.color6,
        markup = function(t) return '<b>' .. t .. '</b>' end,
        shape =gears.shape.rounded_rect
    }
    styles.header = {
        fg_color = xrdb.color7,
        bg_color = xrdb.background,
        markup = function(t) return '<b>' .. t .. '</b>' end,
        shape =gears.shape.rounded_rect
    }
    ...
    local function decorate_cell(widget, flag, date)
        ...
        local default_bg = (weekday==0 or weekday==6) and xrdb.color0 or xrdb.background
        local ret = wibox.widget {
            ...
            shape = props.shape,
            shape_border_color = props.border_color or xrdb.color0,
            shape_border_width = props.border_width or 0,
            fg = props.fg_color or xrdb.foreground,
